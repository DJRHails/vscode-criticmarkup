 ...
 *
 * A compound qualifier is hyphenated inside its dotted segment, the way `accept.all-current` is.
 */
const BULK = {
  accept: {
    selection: "criticmarkup.accept.selection",
    all: "criticmarkup.accept.all-suggestions",
  },
  reject: {
    selection: "criticmarkup.reject.selection",
    all: "criticmarkup.reject.all-suggestions",
  },
